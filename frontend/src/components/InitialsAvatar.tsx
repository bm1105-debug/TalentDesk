...
export default function InitialsAvatar({ id, firstName, lastName, size = 'md', style }: Props) {
  ...
  return (
    <div
      className={`${colour} ${sizeClass} rounded-full flex items-center justify-center text-white font-semibold shrink-0`}
      style={style}
    >
      {initials}
    </div>
